...
Python (pandas, numpy) – used for data cleaning, validation, and feature engineering

Tableau – used for interactive visualizations and storytelling
...
How many users successfully move through each stage of the funnel?

At which stages do we lose the most users?

How does the conversion rate change month-over-month?
...
A centered funnel visualization with user counts and drop-off percentages

Monthly conversion trends

MoM conversion change indicators to highlight improvement or decline

Dashboard screenshots are available in the /tableau/dashboard_screenshots folder, and the packaged Tableau workbook is included for deeper exploration.
